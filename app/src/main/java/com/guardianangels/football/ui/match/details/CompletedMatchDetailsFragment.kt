...
import com.guardianangels.football.util.Constants.PREVIOUS_MATCH_DELETED_RESULT_KEY
            ...
            when (it) {
                ...
                is NetworkState.Success -> {
                    ...
                    findNavController().apply {
                        previousBackStackEntry?.savedStateHandle?.set(PREVIOUS_MATCH_DELETED_RESULT_KEY, it.data)
                        getBackStackEntry(R.id.home).savedStateHandle.set(RELOAD_PREVIOUS_MATCHES_KEY, it.data)
                        popBackStack()
                    }
                }
                is NetworkState.Failed -> {
